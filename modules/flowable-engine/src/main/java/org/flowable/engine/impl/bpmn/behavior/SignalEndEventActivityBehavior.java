...
/**
 * @author Chuanhao Wang
 */
public class SignalEndEventActivityBehavior extends FlowNodeActivityBehavior {

    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory.getLogger(SignalEndEventActivityBehavior.class);

    protected EndEvent endEvent;
    protected SignalEventDefinition signalEventDefinition;
    protected boolean processInstanceScope;

    public SignalEndEventActivityBehavior(EndEvent endEvent, SignalEventDefinition signalEventDefinition, Signal signal) {
        if (signal != null) {
    ...
    public void execute(DelegateExecution execution) {
        ...
        for (IOParameter outParameter : endEvent.getOutParameters()) {
