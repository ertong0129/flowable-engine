...
public class TestActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory {
    ...
    @Override
    public SignalEndEventActivityBehavior createSignalEndEventActivityBehavior(EndEvent endEvent, SignalEventDefinition signalEventDefinition, Signal signal) {
        return wrappedActivityBehaviorFactory.createSignalEndEventActivityBehavior(endEvent, signalEventDefinition, signal);
    }
